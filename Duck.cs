...
namespace CubeApp
{
    ...
    /// </summary>
    public sealed class Duck : IMobRenderable
    {
        ...
        string IMobRenderable.MobType => "duck";
        float IMobRenderable.HeadYawLocal => Math.Clamp(WrapAngle(HeadYaw - Yaw), -MaxHeadYaw, MaxHeadYaw);
        ...
        {
            return manager.TryGetLoadedBlock(x, y, z, out var block) && block != BlockRegistry.AirId;
        }
